...
<tr>
		<td><b>번호</b></td>
		<td><%=id%><input type=hidden name=id value='INSERT'></td><!--hidden 은 사용자가 변경해선 안되는 데이터를 보낼 때 사용-->
</tr>
<tr>
		<td><b>제목</b></td>
...
<tr>
		...
		<td><input type=button value="쓰기" OnClick="location.href='gongji_write.jsp?key=<%=id%>'"></td>
